...
public class IDAStarNode implements Node<IDAStarNode> {
    ...
    /**
     * @return An optimistic estimate of the number of moves from this node to
     *         the solution. May be smaller than real value, but never bigger.
     */
    ...
    private void addNode(List<IDAStarNode> boards, int freeRow, int freeCol, int fromRow, int fromCol,
            NodeFilter<IDAStarNode> filter) {
